...
Also note that if a blank (uninitialised) node [imports a definition file](https://www.rabbitmq.com/definitions.html#import-on-boot), it will not create the default virtual host and user.
